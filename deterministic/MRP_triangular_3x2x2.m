% Construct a minimum rigidifying link pattern (MRP) for a 3x2x2 triangular prismatic assembly
%
% Reference:
...
for i=0:nprism-1
    if mod(i,6) == 0 || mod(i,6) == 2  || mod(i,6) == 4  % for 3x3 base only, change if needed
        % edges
        %x1 x2
