% Construct a minimum rigidifying link pattern (MRP) for a 2x3x3 triangular prismatic assembly
%
% Reference:
...
for i=0:nprism-1
    if mod(i,6) == 0 || mod(i,6) == 3  || mod(i,6) == 4  % for 2x3 base only, change if needed
        % edges
        %x1 x2
